...
namespace MrbWrap {
	...
	//! Getter for member function for derived class
	template <class C, class Superclass, class TRuby, class TCpp, TCpp(Superclass::*member)()> void define_getter(mrb_state* mrb, RClass* ruby_class, const char* name) {
