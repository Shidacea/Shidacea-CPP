...
void setup_ruby_class_color(mrb_state* mrb, RClass* ruby_module) {
	...
	// @@@ MRBWRAPDOC_IM Color initialize r=0 g=0 b=0 a=255
	// @return [Color]
	// @param r [Integer]
	// @param g [Integer]
	// @param b [Integer]
	...
	// @@@ MRBWRAPDOC_ATTR Color g Integer rw
	...
	// @@@ MRBWRAPDOC_ATTR Color b Integer rw
	...
	// @@@ MRBWRAPDOC_ATTR Color a Integer rw
