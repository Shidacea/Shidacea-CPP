...
void setup_ruby_class_text(mrb_state* mrb, RClass* ruby_module) {
	...
	// @@@ M_IM Text initialize content font character_size=30
	// @return [Text]
	...
	// @@@ M_ATTR Text character_size Integer rw
	...
	// @@@ M_ATTR Text fill_color Color rw
	...
	// @@@ M_ATTR Text outline_color Color rw
