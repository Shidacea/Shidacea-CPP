...
void setup_ruby_class_floatrect(mrb_state* mrb, RClass* ruby_module) {
	...
	// @@@ MRBWRAPDOC_ATTR FloatRect width Float rw
	...
	// @@@ MRBWRAPDOC_ATTR FloatRect height Float rw
	...
	// @@@ MRBWRAPDOC_ATTR FloatRect left Float rw
	...
	// @@@ MRBWRAPDOC_ATTR FloatRect top Float rw
